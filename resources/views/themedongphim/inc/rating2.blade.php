...
<script src="/themes/dongphim/rating2/jquery.raty.js"></script>
<script>
    var rated = false;
    $('#star').raty({
        number: 10,
        starHalf: '/themes/dongphim/rating2/images/star-half.png',
        starOff: '/themes/dongphim/rating2/images/star-off.png',
        starOn: '/themes/dongphim/rating2/images/star-on.png',
