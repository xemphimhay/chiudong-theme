...
@push('scripts')
    <script src="/themes/dongphim/static/player/skin/juicycodes.js"></script>
    <link href="/themes/dongphim/static/player/skin/juicycodes.css" rel="stylesheet" type="text/css">

    {{--    <script src="/themes/dongphim/static/player/js/p2p-media-loader-core.min.js"></script> --}}
    {{--    <script src="/themes/dongphim/static/player/js/p2p-media-loader-hlsjs.min.js"></script> --}}

    <script src="/themes/dongphim/static/player/jwplayer.js"></script>
            ...
            if (type == 'embed') {
                if (vastAds) {
                    ...
                    const objSetupFake = {
                        ...
                        aspectratio: "16:9",
                        width: "100%",
                        file: "/themes/dongphim/static/player/1s_blank.mp4",
                        volume: 100,
                        mute: false,
                        autostart: true,
                        advertising: {
