...
namespace Ophim\ThemeDongphim\Controllers;
...
class ThemeDongphimController
{
    ...
    public function index(Request $request)
    {
        if ($request['search'] || $request['filter']) {
            ...
            return view('themes::themedongphim.catalog', [
                'data' => $data,
                'search' => $request['search'],
                'section_name' => "Tìm kiếm phim: $request->search"
            ]);
        }
        return view('themes::themedongphim.index', [
    ...
    public function getMovieOverview(Request $request)
    {
        ...
        return view('themes::themedongphim.single', [
            'currentMovie' => $movie,
    ...
    public function getEpisode(Request $request)
    {
        ...
        return view('themes::themedongphim.episode', [
            'currentMovie' => $movie,
            'movie_related' => $movie_related,
            'episode' => $episode,
